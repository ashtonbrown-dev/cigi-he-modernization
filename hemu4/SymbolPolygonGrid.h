// MyCUG.h : interface of the CSymbolPolygonGrid class
//
/////////////////////////////////////////////////////////////////////////////

#ifndef _SYMBOLPOLYGONGRID_H_
#define _SYMBOLPOLYGONGRID_H_

#include "ugctrl.h"

class CSymbolPolygonGrid: public CUGCtrl
{
public:
    enum {
        ColVertexU = 0,
    ...
    enum {
        MaxRows = 8190	// (max pckt size - header) / polygon def size ==> ( 65528 - 8 ) / 8
    };
