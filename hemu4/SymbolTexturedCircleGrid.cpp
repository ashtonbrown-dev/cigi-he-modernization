...
BEGIN_MESSAGE_MAP(CSymbolTexturedCircleGrid, CUGCtrl)
    //{{AFX_MSG_MAP(CSymbolTexturedCircleGrid)
...
/////////////////////////////////////////////////////////////////////////////
// Standard CSymbolTexturedCircleGrid construction/destruction
CSymbolTexturedCircleGrid::CSymbolTexturedCircleGrid()
{
}
...
void CSymbolTexturedCircleGrid::OnSetup()
{
    const int rows = 0;
    const int cols = 10;
    ...
    GetCell(ColCenterU, -1, &cell);
    cell.SetText("Center U");
    SetCell(ColCenterU, -1, &cell);

    GetCell(ColCenterV, -1, &cell);
    cell.SetText("Center V");
    SetCell(ColCenterV, -1, &cell);

    GetCell(ColRadius, -1, &cell);
    cell.SetText("Radius");
    SetCell(ColRadius, -1, &cell);

    GetCell(ColInnerRadius, -1, &cell);
    cell.SetText("Inner Radius");
    SetCell(ColInnerRadius, -1, &cell);

    GetCell(ColStartAngle, -1, &cell);
    cell.SetText("Start Angle");
    SetCell(ColStartAngle, -1, &cell);

    GetCell(ColEndAngle, -1, &cell);
    cell.SetText("End Angle");
    SetCell(ColEndAngle, -1, &cell);

    GetCell(ColTextureS, -1, &cell);
    cell.SetText("Tex Coord S");
    SetCell(ColTextureS, -1, &cell);

    GetCell(ColTextureT, -1, &cell);
    cell.SetText("Tex Coord T");
    SetCell(ColTextureT, -1, &cell);

    GetCell(ColTextureRadius, -1, &cell);
    cell.SetText("Tex Radius");
    SetCell(ColTextureRadius, -1, &cell);

    GetCell(ColTextureRotation, -1, &cell);
    cell.SetText("Tex Rotation");
    SetCell(ColTextureRotation, -1, &cell);
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnSheetSetup(int sheetNumber)
{
...
int CSymbolTexturedCircleGrid::OnCanMove(int oldcol, long oldrow, int newcol, long newrow)
{
...
int CSymbolTexturedCircleGrid::OnCanViewMove(int oldcol, long oldrow, int newcol, long newrow)
{
    UNREFERENCED_PARAMETER(oldcol);
    UNREFERENCED_PARAMETER(oldrow);
    UNREFERENCED_PARAMETER(newcol);
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnHitBottom(long numrows, long rowspast, long rowsfound)
{
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnHitTop(long numrows, long rowspast)
{
    UNREFERENCED_PARAMETER(numrows);
    UNREFERENCED_PARAMETER(rowspast);
}
...
int CSymbolTexturedCircleGrid::OnCanSizeCol(int col)
{
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnColSizing(int col, int *width)
{
    UNREFERENCED_PARAMETER(col);
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnColSized(int col, int *width)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(*width);
}
...
//      TRUE - to allow sizing
//      FALSE - to prevent sizing
int CSymbolTexturedCircleGrid::OnCanSizeRow(long row)
{
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnRowSizing(long row, int *height)
{
    UNREFERENCED_PARAMETER(row);
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnRowSized(long row, int *height)
{
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(*height);
}
...
//      TRUE - to allow sizing
//      FALSE - to prevent sizing
int CSymbolTexturedCircleGrid::OnCanSizeSideHdg()
{
    return TRUE;
}
...
int CSymbolTexturedCircleGrid::OnSideHdgSizing(int *width)
{
    UNREFERENCED_PARAMETER(*width);
    return TRUE;
}
...
int CSymbolTexturedCircleGrid::OnSideHdgSized(int *width)
{
    UNREFERENCED_PARAMETER(*width);
    return TRUE;
}
...
//      TRUE - to allow sizing
//      FALSE - to prevent sizing
int CSymbolTexturedCircleGrid::OnCanSizeTopHdg()
{
    return TRUE;
}
...
//      TRUE - to accept current new size
//      FALSE - to stop sizing, the size is either too large or too small
int CSymbolTexturedCircleGrid::OnTopHdgSizing(int *height)
{
    UNREFERENCED_PARAMETER(*height);
    return TRUE;
}
...
//      TRUE - to accept new size
//      FALSE - to revert to old size
int CSymbolTexturedCircleGrid::OnTopHdgSized(int *height)
{
    UNREFERENCED_PARAMETER(*height);
    return TRUE;
}
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnColChange(int oldcol, int newcol)
{
    UNREFERENCED_PARAMETER(oldcol);
    UNREFERENCED_PARAMETER(newcol);
}
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnRowChange(long oldrow, long newrow)
{
    UNREFERENCED_PARAMETER(oldrow);
    UNREFERENCED_PARAMETER(newrow);
}
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnCellChange(int oldcol, int newcol, long oldrow, long newrow)
{
    UNREFERENCED_PARAMETER(oldcol);
    UNREFERENCED_PARAMETER(newcol);
    UNREFERENCED_PARAMETER(oldrow);
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnLeftColChange(int oldcol, int newcol)
{
    UNREFERENCED_PARAMETER(oldcol);
    UNREFERENCED_PARAMETER(newcol);
}
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnTopRowChange(long oldrow, long newrow)
{
    UNREFERENCED_PARAMETER(oldrow);
    UNREFERENCED_PARAMETER(newrow);
}
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnViewMoved(int nScrolDir, long oldPos, long newPos)
{
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnSelectionChanged(int startCol, long startRow, int endCol, long endRow, int blockNum)
{
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnLClicked(int col, long row, int updn, RECT *rect, POINT *point, int processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnRClicked(int col, long row, int updn, RECT *rect, POINT *point, int processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(updn);
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnDClicked(int col, long row, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(*rect);
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnMouseMove(int col, long row, POINT *point, UINT nFlags, BOOL processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(*point);
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnTH_LClicked(int col, long row, int updn, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(updn);
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnTH_RClicked(int col, long row, int updn, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(updn);
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnTH_DClicked(int col, long row, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(*rect);
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnSH_LClicked(int col, long row, int updn, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(updn);
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnSH_RClicked(int col, long row, int updn, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(updn);
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnSH_DClicked(int col, long row, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(*rect);
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnCB_LClicked(int updn, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(updn);
    UNREFERENCED_PARAMETER(*rect);
    UNREFERENCED_PARAMETER(*point);
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnCB_RClicked(int updn, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(updn);
    UNREFERENCED_PARAMETER(*rect);
    UNREFERENCED_PARAMETER(*point);
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnCB_DClicked(RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(*rect);
    UNREFERENCED_PARAMETER(*point);
    UNREFERENCED_PARAMETER(processed);
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnKeyDown(UINT *vcKey, BOOL processed)
{
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnKeyUp(UINT *vcKey, BOOL processed)
{
    UNREFERENCED_PARAMETER(*vcKey);
    UNREFERENCED_PARAMETER(processed);
    //  GetScrollBarCtrl(SB_HORZ)->EnableScrollBar(ESB_DISABLE_BOTH);
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnCharDown(UINT *vcKey, BOOL processed)
{
    StartEdit(*vcKey);
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnGetCell(int col, long row, CUGCell *cell)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnSetCell(int col, long row, CUGCell *cell)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(*cell);
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnDataSourceNotify(int ID, long msg, long param)
{
...
int CSymbolTexturedCircleGrid::OnCellTypeNotify(long ID, int col, long row, long msg, long param)
{
    UNREFERENCED_PARAMETER(ID);
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
...
int CSymbolTexturedCircleGrid::OnEditStart(int col, long row, CWnd **edit)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
...
int CSymbolTexturedCircleGrid::OnEditVerify(int col, long row, CWnd *edit, UINT *vcKey)
{
    if ((*vcKey >= '0' && *vcKey <= '9') || (*vcKey == '.'))
        return TRUE;
...
int CSymbolTexturedCircleGrid::OnEditFinish(int col, long row, CWnd *edit, LPCTSTR string, BOOL cancelFlag)
{
    if (string == "")
        QuickSetText(col, row, "0.0");
...
int CSymbolTexturedCircleGrid::OnEditContinue(int oldcol, long oldrow, int *newcol, long *newrow)
{
    if ((oldcol == GetNumberCols()) && (*newcol == 0)) {
        // If we're in the last row, add a new row and move to the first column.
        ...
        // If we're in the first row, wrap to the last.
        if (*newrow == 0) {
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnMenuCommand(int col, long row, int section, int item)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
...
int CSymbolTexturedCircleGrid::OnMenuStart(int col, long row, int section)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(section);
...
DWORD CSymbolTexturedCircleGrid::OnGetContextHelpID(int col, long row, int section)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(section);
...
int CSymbolTexturedCircleGrid::OnHint(int col, long row, int section, CString *string)
{
    UNREFERENCED_PARAMETER(section);
...
//      TRUE - to show the hint
//      FALSE - to prevent the hint from showing
int CSymbolTexturedCircleGrid::OnVScrollHint(long row, CString *string)
{
    UNREFERENCED_PARAMETER(row);
...
//      TRUE - to show the hint
//      FALSE - to prevent the hint from showing
int CSymbolTexturedCircleGrid::OnHScrollHint(int col, CString *string)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(*string);
    return TRUE;
...
DROPEFFECT CSymbolTexturedCircleGrid::OnDragEnter(COleDataObject *pDataObject)
{
...
//      DROPEFFECT_NONE - no drag and drop
//      DROPEFFECT_COPY - allow drag and drop for copying
DROPEFFECT CSymbolTexturedCircleGrid::OnDragOver(COleDataObject *pDataObject, int col, long row)
{
    UNREFERENCED_PARAMETER(*pDataObject);
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
...
//      DROPEFFECT_NONE - no drag and drop
//      DROPEFFECT_COPY - allow drag and drop for copying
DROPEFFECT CSymbolTexturedCircleGrid::OnDragDrop(COleDataObject *pDataObject, int col, long row)
{
    UNREFERENCED_PARAMETER(*pDataObject);
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnScreenDCSetup(CDC *dc, int section)
{
...
int CSymbolTexturedCircleGrid::OnSortEvaluate(CUGCell *cell1, CUGCell *cell2, int flags)
{
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnTabSelected(int ID)
{
    UNREFERENCED_PARAMETER(ID);
}
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnAdjustComponentSizes(RECT *grid, RECT *topHdg, RECT *sideHdg,
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnDrawFocusRect(CDC *dc, RECT *rect)
{
...
COLORREF CSymbolTexturedCircleGrid::OnGetDefBackColor(int section)
{
    UNREFERENCED_PARAMETER(section);
...
//      <none>
//
void CSymbolTexturedCircleGrid::OnSetFocus(int section)
{
    UNREFERENCED_PARAMETER(section);
}
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnKillFocus(int section, CWnd *pNewWnd)
{
    UNREFERENCED_PARAMETER(section);
}
...
BOOL CSymbolTexturedCircleGrid::OnColSwapStart(int col)
{
    UNREFERENCED_PARAMETER(col);
    return TRUE;
}
...
//      TRUE - to allow for the swap to take place
//      FALSE - to disallow the swap
BOOL CSymbolTexturedCircleGrid::OnCanColSwap(int fromCol, int toCol)
{
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnColSwapped(int fromCol, int toCol)
{
    UNREFERENCED_PARAMETER(fromCol);
    UNREFERENCED_PARAMETER(toCol);
}
...
//  Return:
//      <none>
void CSymbolTexturedCircleGrid::OnTrackingWindowMoved(RECT *origRect, RECT *newRect)
{
    UNREFERENCED_PARAMETER(*origRect);
    UNREFERENCED_PARAMETER(*newRect);
}

int CSymbolTexturedCircleGrid::AddNewRow(void)
{
    const int maxCircles = 9;
    int numRows = GetNumberRows();

    if (numRows >= maxCircles)
        return -1;

    //if (!RowHasBeenEdited(numRows))
    //   return numRows;
    ...
    // Set the row number.
    CUGCell cell;
    GetCell(-1, numRows - 1, &cell);
    CString rowLabel;
    rowLabel.Format("%d", numRows);
    cell.SetText(rowLabel);
    SetCell(-1, numRows - 1, &cell);

    // Initialize all of the cells.
    InitializeRow(numRows - 1);

    return numRows;
}

int CSymbolTexturedCircleGrid::DeleteSelectedRow(void)
{
...
bool CSymbolTexturedCircleGrid::RowHasBeenEdited(int row)
{
    int lastRow = GetNumberRows() - 1;
    int numCols = GetNumberCols();

    for (int i = 0; i < numCols; ++i) {
        CUGCell cell;
        GetCell(i, lastRow, &cell);
...
void CSymbolTexturedCircleGrid::InitializeRow(int row)
{
    int numCols = GetNumberCols();

    for (int i = 0; i < numCols; ++i) {
        QuickSetText(i, row, "0.0");
    }
}

void CSymbolTexturedCircleGrid::RenumberRows(void)
{
    int numRows = GetNumberRows();
