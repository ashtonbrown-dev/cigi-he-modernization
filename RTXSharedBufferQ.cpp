...
//
///////////////////////////////////////////////////////////////////////////////
RTXSharedBufferQ::RTXSharedBufferQ()
{
    m_bufflengths = NULL;
    m_size = NULL;
    m_bottom = NULL;
...
RTXSharedBufferQ::~RTXSharedBufferQ()
{
    ...
    // Now all we have to do is close the handles.  When all objects have
...
//
///////////////////////////////////////////////////////////////////////////////
long int RTXSharedBufferQ::Create(const char *name, const long buffcount, const long buffsize)
{
    ...
    char *sharedname = (char *)malloc(strlen(name) + strlen(".RTXSharedBufferQ.sharedmem") + 1);
    strcpy((char *)sharedname, name);
    strcat((char *)sharedname, ".RTXSharedBufferQ.sharedmem");

    char *mutexname = (char *)malloc(strlen(name) + strlen(".RTXSharedBufferQ.mutex") + 1);
    strcpy((char *)mutexname, name);
    strcat((char *)mutexname, ".RTXSharedBufferQ.mutex");
...
//
///////////////////////////////////////////////////////////////////////////////
long int RTXSharedBufferQ::Push(const char *buffer, const long length)
{
    if (*m_size == 0)
        return -2;

    int waitval = RtWaitForSingleObject(m_mutex, TIMEOUT_MILLISEC);
...
//
///////////////////////////////////////////////////////////////////////////////
long int RTXSharedBufferQ::Pop(char *buffer, const long length)
{
    static int copysize;
    ...
    if (RtWaitForSingleObject(m_mutex, TIMEOUT_MILLISEC) != WAIT_OBJECT_0)
        return -1;
