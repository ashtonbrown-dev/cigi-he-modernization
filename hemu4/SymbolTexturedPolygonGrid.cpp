...
BEGIN_MESSAGE_MAP(CSymbolTexturedPolygonGrid, CUGCtrl)
    //{{AFX_MSG_MAP(CSymbolTexturedPolygonGrid)
...
/////////////////////////////////////////////////////////////////////////////
// Standard CSymbolTexturedPolygonGrid construction/destruction
CSymbolTexturedPolygonGrid::CSymbolTexturedPolygonGrid()
{
}
...
void CSymbolTexturedPolygonGrid::OnSetup()
{
    const int rows = 0;
    const int cols = 4;
    ...
    GetCell(ColVertexU, -1, &cell);
    cell.SetText("Vertex U");
    SetCell(ColVertexU, -1, &cell);

    GetCell(ColVertexV, -1, &cell);
    cell.SetText("Vertex V");
    SetCell(ColVertexV, -1, &cell);
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnSheetSetup(int sheetNumber)
{
...
int CSymbolTexturedPolygonGrid::OnCanMove(int oldcol, long oldrow, int newcol, long newrow)
{
...
int CSymbolTexturedPolygonGrid::OnCanViewMove(int oldcol, long oldrow, int newcol, long newrow)
{
    UNREFERENCED_PARAMETER(oldcol);
    UNREFERENCED_PARAMETER(oldrow);
    UNREFERENCED_PARAMETER(newcol);
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnHitBottom(long numrows, long rowspast, long rowsfound)
{
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnHitTop(long numrows, long rowspast)
{
    UNREFERENCED_PARAMETER(numrows);
    UNREFERENCED_PARAMETER(rowspast);
}
...
int CSymbolTexturedPolygonGrid::OnCanSizeCol(int col)
{
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnColSizing(int col, int *width)
{
    UNREFERENCED_PARAMETER(col);
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnColSized(int col, int *width)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(*width);
}
...
//      TRUE - to allow sizing
//      FALSE - to prevent sizing
int CSymbolTexturedPolygonGrid::OnCanSizeRow(long row)
{
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnRowSizing(long row, int *height)
{
    UNREFERENCED_PARAMETER(row);
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnRowSized(long row, int *height)
{
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(*height);
}
...
//      TRUE - to allow sizing
//      FALSE - to prevent sizing
int CSymbolTexturedPolygonGrid::OnCanSizeSideHdg()
{
    return TRUE;
}
...
int CSymbolTexturedPolygonGrid::OnSideHdgSizing(int *width)
{
    UNREFERENCED_PARAMETER(*width);
    return TRUE;
}
...
int CSymbolTexturedPolygonGrid::OnSideHdgSized(int *width)
{
    UNREFERENCED_PARAMETER(*width);
    return TRUE;
}
...
//      TRUE - to allow sizing
//      FALSE - to prevent sizing
int CSymbolTexturedPolygonGrid::OnCanSizeTopHdg()
{
    return TRUE;
}
...
//      TRUE - to accept current new size
//      FALSE - to stop sizing, the size is either too large or too small
int CSymbolTexturedPolygonGrid::OnTopHdgSizing(int *height)
{
    UNREFERENCED_PARAMETER(*height);
    return TRUE;
}
...
//      TRUE - to accept new size
//      FALSE - to revert to old size
int CSymbolTexturedPolygonGrid::OnTopHdgSized(int *height)
{
    UNREFERENCED_PARAMETER(*height);
    return TRUE;
}
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnColChange(int oldcol, int newcol)
{
    UNREFERENCED_PARAMETER(oldcol);
    UNREFERENCED_PARAMETER(newcol);
}
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnRowChange(long oldrow, long newrow)
{
    UNREFERENCED_PARAMETER(oldrow);
    UNREFERENCED_PARAMETER(newrow);
}
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnCellChange(int oldcol, int newcol, long oldrow, long newrow)
{
    UNREFERENCED_PARAMETER(oldcol);
    UNREFERENCED_PARAMETER(newcol);
    UNREFERENCED_PARAMETER(oldrow);
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnLeftColChange(int oldcol, int newcol)
{
    UNREFERENCED_PARAMETER(oldcol);
    UNREFERENCED_PARAMETER(newcol);
}
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnTopRowChange(long oldrow, long newrow)
{
    UNREFERENCED_PARAMETER(oldrow);
    UNREFERENCED_PARAMETER(newrow);
}
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnViewMoved(int nScrolDir, long oldPos, long newPos)
{
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnSelectionChanged(int startCol, long startRow, int endCol, long endRow, int blockNum)
{
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnLClicked(int col, long row, int updn, RECT *rect, POINT *point, int processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnRClicked(int col, long row, int updn, RECT *rect, POINT *point, int processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(updn);
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnDClicked(int col, long row, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(*rect);
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnMouseMove(int col, long row, POINT *point, UINT nFlags, BOOL processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(*point);
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnTH_LClicked(int col, long row, int updn, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(updn);
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnTH_RClicked(int col, long row, int updn, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(updn);
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnTH_DClicked(int col, long row, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(*rect);
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnSH_LClicked(int col, long row, int updn, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(updn);
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnSH_RClicked(int col, long row, int updn, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(updn);
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnSH_DClicked(int col, long row, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(*rect);
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnCB_LClicked(int updn, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(updn);
    UNREFERENCED_PARAMETER(*rect);
    UNREFERENCED_PARAMETER(*point);
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnCB_RClicked(int updn, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(updn);
    UNREFERENCED_PARAMETER(*rect);
    UNREFERENCED_PARAMETER(*point);
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnCB_DClicked(RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(*rect);
    UNREFERENCED_PARAMETER(*point);
    UNREFERENCED_PARAMETER(processed);
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnKeyDown(UINT *vcKey, BOOL processed)
{
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnKeyUp(UINT *vcKey, BOOL processed)
{
    UNREFERENCED_PARAMETER(*vcKey);
    UNREFERENCED_PARAMETER(processed);
    //  GetScrollBarCtrl(SB_HORZ)->EnableScrollBar(ESB_DISABLE_BOTH);
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnCharDown(UINT *vcKey, BOOL processed)
{
    StartEdit(*vcKey);
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnGetCell(int col, long row, CUGCell *cell)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnSetCell(int col, long row, CUGCell *cell)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(*cell);
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnDataSourceNotify(int ID, long msg, long param)
{
...
int CSymbolTexturedPolygonGrid::OnCellTypeNotify(long ID, int col, long row, long msg, long param)
{
    UNREFERENCED_PARAMETER(ID);
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
...
int CSymbolTexturedPolygonGrid::OnEditStart(int col, long row, CWnd **edit)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
...
int CSymbolTexturedPolygonGrid::OnEditVerify(int col, long row, CWnd *edit, UINT *vcKey)
{
...
int CSymbolTexturedPolygonGrid::OnEditFinish(int col, long row, CWnd *edit, LPCTSTR string, BOOL cancelFlag)
{
    if (string == "")
...
int CSymbolTexturedPolygonGrid::OnEditContinue(int oldcol, long oldrow, int *newcol, long *newrow)
{
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnMenuCommand(int col, long row, int section, int item)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
...
int CSymbolTexturedPolygonGrid::OnMenuStart(int col, long row, int section)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(section);
...
DWORD CSymbolTexturedPolygonGrid::OnGetContextHelpID(int col, long row, int section)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(section);
...
int CSymbolTexturedPolygonGrid::OnHint(int col, long row, int section, CString *string)
{
    UNREFERENCED_PARAMETER(section);
...
//      TRUE - to show the hint
//      FALSE - to prevent the hint from showing
int CSymbolTexturedPolygonGrid::OnVScrollHint(long row, CString *string)
{
    UNREFERENCED_PARAMETER(row);
...
//      TRUE - to show the hint
//      FALSE - to prevent the hint from showing
int CSymbolTexturedPolygonGrid::OnHScrollHint(int col, CString *string)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(*string);
    return TRUE;
...
DROPEFFECT CSymbolTexturedPolygonGrid::OnDragEnter(COleDataObject *pDataObject)
{
...
//      DROPEFFECT_NONE - no drag and drop
//      DROPEFFECT_COPY - allow drag and drop for copying
DROPEFFECT CSymbolTexturedPolygonGrid::OnDragOver(COleDataObject *pDataObject, int col, long row)
{
    UNREFERENCED_PARAMETER(*pDataObject);
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
...
//      DROPEFFECT_NONE - no drag and drop
//      DROPEFFECT_COPY - allow drag and drop for copying
DROPEFFECT CSymbolTexturedPolygonGrid::OnDragDrop(COleDataObject *pDataObject, int col, long row)
{
    UNREFERENCED_PARAMETER(*pDataObject);
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnScreenDCSetup(CDC *dc, int section)
{
...
int CSymbolTexturedPolygonGrid::OnSortEvaluate(CUGCell *cell1, CUGCell *cell2, int flags)
{
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnTabSelected(int ID)
{
    UNREFERENCED_PARAMETER(ID);
}
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnAdjustComponentSizes(RECT *grid, RECT *topHdg, RECT *sideHdg,
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnDrawFocusRect(CDC *dc, RECT *rect)
{
...
COLORREF CSymbolTexturedPolygonGrid::OnGetDefBackColor(int section)
{
    UNREFERENCED_PARAMETER(section);
...
//      <none>
//
void CSymbolTexturedPolygonGrid::OnSetFocus(int section)
{
    UNREFERENCED_PARAMETER(section);
}
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnKillFocus(int section, CWnd *pNewWnd)
{
    UNREFERENCED_PARAMETER(section);
}
...
BOOL CSymbolTexturedPolygonGrid::OnColSwapStart(int col)
{
    UNREFERENCED_PARAMETER(col);
    return TRUE;
}
...
//      TRUE - to allow for the swap to take place
//      FALSE - to disallow the swap
BOOL CSymbolTexturedPolygonGrid::OnCanColSwap(int fromCol, int toCol)
{
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnColSwapped(int fromCol, int toCol)
{
    UNREFERENCED_PARAMETER(fromCol);
    UNREFERENCED_PARAMETER(toCol);
}
...
//  Return:
//      <none>
void CSymbolTexturedPolygonGrid::OnTrackingWindowMoved(RECT *origRect, RECT *newRect)
{
    UNREFERENCED_PARAMETER(*origRect);
    UNREFERENCED_PARAMETER(*newRect);
}

int CSymbolTexturedPolygonGrid::AddNewRow(void)
{
...
int CSymbolTexturedPolygonGrid::DeleteSelectedRow(void)
{
...
bool CSymbolTexturedPolygonGrid::RowHasBeenEdited(int row)
{
...
void CSymbolTexturedPolygonGrid::InitializeRow(int row)
{
    int numCols = GetNumberCols();
...
void CSymbolTexturedPolygonGrid::RenumberRows(void)
{
    int numRows = GetNumberRows();
