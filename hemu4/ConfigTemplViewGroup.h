...
#ifndef _CONFIGTEMPLVIEWGROUP_H_
#define _CONFIGTEMPLVIEWGROUP_H_

#include "stdafx.h"
#include "ConfigTemplComponent.h"
#include "linkedlist.h"

class TEMPL_VIEWGROUP : public CObject
{
public:
    DECLARE_SERIAL(TEMPL_VIEWGROUP)

    TEMPL_VIEWGROUP();
    ~TEMPL_VIEWGROUP();
    TEMPL_VIEWGROUP &operator=(const TEMPL_VIEWGROUP &rhs);
