...
BEGIN_MESSAGE_MAP(CSymbolPolygonGrid, CUGCtrl)
    //{{AFX_MSG_MAP(CSymbolPolygonGrid)
...
/////////////////////////////////////////////////////////////////////////////
// Standard CSymbolPolygonGrid construction/destruction
CSymbolPolygonGrid::CSymbolPolygonGrid()
{
}
...
void CSymbolPolygonGrid::OnSetup()
{
    const int rows = 0;
    const int cols = 2;
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnSheetSetup(int sheetNumber)
{
...
int CSymbolPolygonGrid::OnCanMove(int oldcol, long oldrow, int newcol, long newrow)
{
...
int CSymbolPolygonGrid::OnCanViewMove(int oldcol, long oldrow, int newcol, long newrow)
{
    UNREFERENCED_PARAMETER(oldcol);
    UNREFERENCED_PARAMETER(oldrow);
    UNREFERENCED_PARAMETER(newcol);
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnHitBottom(long numrows, long rowspast, long rowsfound)
{
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnHitTop(long numrows, long rowspast)
{
    UNREFERENCED_PARAMETER(numrows);
    UNREFERENCED_PARAMETER(rowspast);
}
...
int CSymbolPolygonGrid::OnCanSizeCol(int col)
{
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnColSizing(int col, int *width)
{
    UNREFERENCED_PARAMETER(col);
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnColSized(int col, int *width)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(*width);
}
...
//      TRUE - to allow sizing
//      FALSE - to prevent sizing
int CSymbolPolygonGrid::OnCanSizeRow(long row)
{
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnRowSizing(long row, int *height)
{
    UNREFERENCED_PARAMETER(row);
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnRowSized(long row, int *height)
{
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(*height);
}
...
//      TRUE - to allow sizing
//      FALSE - to prevent sizing
int CSymbolPolygonGrid::OnCanSizeSideHdg()
{
    return TRUE;
}
...
int CSymbolPolygonGrid::OnSideHdgSizing(int *width)
{
    UNREFERENCED_PARAMETER(*width);
    return TRUE;
}
...
int CSymbolPolygonGrid::OnSideHdgSized(int *width)
{
    UNREFERENCED_PARAMETER(*width);
    return TRUE;
}
...
//      TRUE - to allow sizing
//      FALSE - to prevent sizing
int CSymbolPolygonGrid::OnCanSizeTopHdg()
{
    return TRUE;
}
...
//      TRUE - to accept current new size
//      FALSE - to stop sizing, the size is either too large or too small
int CSymbolPolygonGrid::OnTopHdgSizing(int *height)
{
    UNREFERENCED_PARAMETER(*height);
    return TRUE;
}
...
//      TRUE - to accept new size
//      FALSE - to revert to old size
int CSymbolPolygonGrid::OnTopHdgSized(int *height)
{
    UNREFERENCED_PARAMETER(*height);
    return TRUE;
}
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnColChange(int oldcol, int newcol)
{
    UNREFERENCED_PARAMETER(oldcol);
    UNREFERENCED_PARAMETER(newcol);
}
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnRowChange(long oldrow, long newrow)
{
    UNREFERENCED_PARAMETER(oldrow);
    UNREFERENCED_PARAMETER(newrow);
}
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnCellChange(int oldcol, int newcol, long oldrow, long newrow)
{
    UNREFERENCED_PARAMETER(oldcol);
    UNREFERENCED_PARAMETER(newcol);
    UNREFERENCED_PARAMETER(oldrow);
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnLeftColChange(int oldcol, int newcol)
{
    UNREFERENCED_PARAMETER(oldcol);
    UNREFERENCED_PARAMETER(newcol);
}
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnTopRowChange(long oldrow, long newrow)
{
    UNREFERENCED_PARAMETER(oldrow);
    UNREFERENCED_PARAMETER(newrow);
}
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnViewMoved(int nScrolDir, long oldPos, long newPos)
{
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnSelectionChanged(int startCol, long startRow, int endCol, long endRow, int blockNum)
{
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnLClicked(int col, long row, int updn, RECT *rect, POINT *point, int processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnRClicked(int col, long row, int updn, RECT *rect, POINT *point, int processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(updn);
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnDClicked(int col, long row, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(*rect);
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnMouseMove(int col, long row, POINT *point, UINT nFlags, BOOL processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(*point);
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnTH_LClicked(int col, long row, int updn, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(updn);
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnTH_RClicked(int col, long row, int updn, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(updn);
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnTH_DClicked(int col, long row, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(*rect);
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnSH_LClicked(int col, long row, int updn, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(updn);
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnSH_RClicked(int col, long row, int updn, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(updn);
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnSH_DClicked(int col, long row, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(*rect);
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnCB_LClicked(int updn, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(updn);
    UNREFERENCED_PARAMETER(*rect);
    UNREFERENCED_PARAMETER(*point);
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnCB_RClicked(int updn, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(updn);
    UNREFERENCED_PARAMETER(*rect);
    UNREFERENCED_PARAMETER(*point);
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnCB_DClicked(RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(*rect);
    UNREFERENCED_PARAMETER(*point);
    UNREFERENCED_PARAMETER(processed);
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnKeyDown(UINT *vcKey, BOOL processed)
{
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnKeyUp(UINT *vcKey, BOOL processed)
{
    UNREFERENCED_PARAMETER(*vcKey);
    UNREFERENCED_PARAMETER(processed);
    //  GetScrollBarCtrl(SB_HORZ)->EnableScrollBar(ESB_DISABLE_BOTH);
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnCharDown(UINT *vcKey, BOOL processed)
{
    StartEdit(*vcKey);
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnGetCell(int col, long row, CUGCell *cell)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnSetCell(int col, long row, CUGCell *cell)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(*cell);
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnDataSourceNotify(int ID, long msg, long param)
{
...
int CSymbolPolygonGrid::OnCellTypeNotify(long ID, int col, long row, long msg, long param)
{
    UNREFERENCED_PARAMETER(ID);
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
...
int CSymbolPolygonGrid::OnEditStart(int col, long row, CWnd **edit)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
...
int CSymbolPolygonGrid::OnEditVerify(int col, long row, CWnd *edit, UINT *vcKey)
{
...
int CSymbolPolygonGrid::OnEditFinish(int col, long row, CWnd *edit, LPCTSTR string, BOOL cancelFlag)
{
    if (string == "")
...
int CSymbolPolygonGrid::OnEditContinue(int oldcol, long oldrow, int *newcol, long *newrow)
{
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnMenuCommand(int col, long row, int section, int item)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
...
int CSymbolPolygonGrid::OnMenuStart(int col, long row, int section)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(section);
...
DWORD CSymbolPolygonGrid::OnGetContextHelpID(int col, long row, int section)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(section);
...
int CSymbolPolygonGrid::OnHint(int col, long row, int section, CString *string)
{
    UNREFERENCED_PARAMETER(section);
...
//      TRUE - to show the hint
//      FALSE - to prevent the hint from showing
int CSymbolPolygonGrid::OnVScrollHint(long row, CString *string)
{
    UNREFERENCED_PARAMETER(row);
...
//      TRUE - to show the hint
//      FALSE - to prevent the hint from showing
int CSymbolPolygonGrid::OnHScrollHint(int col, CString *string)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(*string);
    return TRUE;
...
DROPEFFECT CSymbolPolygonGrid::OnDragEnter(COleDataObject *pDataObject)
{
...
//      DROPEFFECT_NONE - no drag and drop
//      DROPEFFECT_COPY - allow drag and drop for copying
DROPEFFECT CSymbolPolygonGrid::OnDragOver(COleDataObject *pDataObject, int col, long row)
{
    UNREFERENCED_PARAMETER(*pDataObject);
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
...
//      DROPEFFECT_NONE - no drag and drop
//      DROPEFFECT_COPY - allow drag and drop for copying
DROPEFFECT CSymbolPolygonGrid::OnDragDrop(COleDataObject *pDataObject, int col, long row)
{
    UNREFERENCED_PARAMETER(*pDataObject);
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnScreenDCSetup(CDC *dc, int section)
{
...
int CSymbolPolygonGrid::OnSortEvaluate(CUGCell *cell1, CUGCell *cell2, int flags)
{
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnTabSelected(int ID)
{
    UNREFERENCED_PARAMETER(ID);
}
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnAdjustComponentSizes(RECT *grid, RECT *topHdg, RECT *sideHdg,
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnDrawFocusRect(CDC *dc, RECT *rect)
{
...
COLORREF CSymbolPolygonGrid::OnGetDefBackColor(int section)
{
    UNREFERENCED_PARAMETER(section);
...
//      <none>
//
void CSymbolPolygonGrid::OnSetFocus(int section)
{
    UNREFERENCED_PARAMETER(section);
}
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnKillFocus(int section, CWnd *pNewWnd)
{
    UNREFERENCED_PARAMETER(section);
}
...
BOOL CSymbolPolygonGrid::OnColSwapStart(int col)
{
    UNREFERENCED_PARAMETER(col);
    return TRUE;
}
...
//      TRUE - to allow for the swap to take place
//      FALSE - to disallow the swap
BOOL CSymbolPolygonGrid::OnCanColSwap(int fromCol, int toCol)
{
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnColSwapped(int fromCol, int toCol)
{
    UNREFERENCED_PARAMETER(fromCol);
    UNREFERENCED_PARAMETER(toCol);
}
...
//  Return:
//      <none>
void CSymbolPolygonGrid::OnTrackingWindowMoved(RECT *origRect, RECT *newRect)
{
    UNREFERENCED_PARAMETER(*origRect);
    UNREFERENCED_PARAMETER(*newRect);
}

int CSymbolPolygonGrid::AddNewRow(void)
{
...
int CSymbolPolygonGrid::DeleteSelectedRow(void)
{
...
bool CSymbolPolygonGrid::RowHasBeenEdited(int row)
{
...
void CSymbolPolygonGrid::InitializeRow(int row)
{
    int numCols = GetNumberCols();
...
void CSymbolPolygonGrid::RenumberRows(void)
{
    int numRows = GetNumberRows();
