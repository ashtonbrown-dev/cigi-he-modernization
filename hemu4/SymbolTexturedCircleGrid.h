// MyCUG.h : interface of the CSymbolTexturedCircleGrid class
//
/////////////////////////////////////////////////////////////////////////////

#ifndef _SYMBOLTEXTUREDCIRCLEGRID_H_
#define _SYMBOLTEXTUREDCIRCLEGRID_H_

#include "ugctrl.h"
#include "cigi4types.h"

class CSymbolTexturedCircleGrid: public CUGCtrl
{
public:
    enum {
        ColCenterU = 0,
    ...
    enum {
        MaxRows = CIGI_SYMBOL_TEXTURED_CIRCLE_DEF_MAX_ELEMENT_CNT
    };

    CSymbolTexturedCircleGrid();
    ~CSymbolTexturedCircleGrid();
...
private:
    ...
    //{{AFX_MSG(CSymbolTexturedCircleGrid)
    // NOTE - the ClassWizard will add and remove member functions here.
    //    DO NOT EDIT what you see in these blocks of generated code!
    //}}AFX_MSG
    DECLARE_MESSAGE_MAP()

    bool RowHasBeenEdited(int row);
    void InitializeRow(int row);
    void RenumberRows(void);
