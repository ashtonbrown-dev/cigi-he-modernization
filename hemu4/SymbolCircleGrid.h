// MyCUG.h : interface of the CSymbolCircleGrid class
//
/////////////////////////////////////////////////////////////////////////////

#ifndef _SYMBOLCIRCLEGRID_H_
#define _SYMBOLCIRCLEGRID_H_

#include "ugctrl.h"

class CSymbolCircleGrid: public CUGCtrl
{
public:
    enum {
        ColCenterU = 0,
    ...
    enum {
        MaxRows = 2729 // (max pckt size - header) / circle def size ==> ( 65520 - 24 ) / 24
    };
