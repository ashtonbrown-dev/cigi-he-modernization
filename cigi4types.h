...
/********************************************************************************************/
// The maximum length of the string is 65516 bytes according to "SISO-STD-013-2014, Standard for 
// Common Image Generator Interface, Version 4.0".  However, the hemu can only handle packets up to 
// CIGI_MAX_PACKET_SIZE (256) and it doesn't even properly handle variable size packets. In reality, 
// the hemu can only handle packets up to 255 since a uint8_t is used for the packet size internally.
//
// To fix this issue reduce the CIGI_SYMBOL_TEXT_DEF_SIZE to 248 bytes.  "All packets must begin/end on
// 64-bit offsets within the message buffer" (256 bytes - 8 bytes = 248 bytes).
//
// Note that this is not an issue with other "variable" size packets (circle, polygon, textured circle, and textured polygon because
// the maximum variable payload + the size of the packet is always <= 256 bytes.
// Previous value: #define CIGI_SYMBOL_TEXT_MAX_TEXT_SIZE 65528
#define CIGI_SYMBOL_TEXT_MAX_TEXT_SIZE 236 // (248 - CIGI_SYMBOL_TEXT_DEF_SIZE)
...
#define CIGI_SYMBOL_TEXT_DEF_SIZE       248
#define CIGI_SYMBOL_TEXT_DEF_BASE_SIZE  12
...
#define CIGI_SYMBOL_CIRCLE_DEF_MAX_ELEMENT_CNT  9
...
#define CIGI_SYMBOL_POLYGON_DEF_MAX_VERTEX_CNT  27
...
#define CIGI_SYMBOL_POLYGON_DEF_SIZE      256
...
#define CIGI_SYMBOL_TEXTURED_CIRCLE_DEF_MAX_ELEMENT_CNT  5
...
#define CIGI_SYMBOL_TEXTURED_CIRCLE_DEF_SIZE      216
...
#define CIGI_SYMBOL_TEXTURED_POLYGON_DEF_MAX_ELEMENT_CNT  14
...
#define CIGI_SYMBOL_TEXTURED_POLYGON_DEF_SIZE      256
