// MyCUG.h : interface of the CSymbolTexturedPolygonGrid class
//
/////////////////////////////////////////////////////////////////////////////

#ifndef _SYMBOLTEXTUREDPOLYGONGRID_H_
#define _SYMBOLTEXTUREDPOLYGONGRID_H_

#include "ugctrl.h"

class CSymbolTexturedPolygonGrid: public CUGCtrl
{
public:
    enum {
        ColVertexU = 0,
...
private:
    ...
    //{{AFX_MSG(CSymbolTexturedPolygonGrid)
