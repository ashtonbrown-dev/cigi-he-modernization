...
BEGIN_MESSAGE_MAP(CSymbolCircleGrid, CUGCtrl)
    //{{AFX_MSG_MAP(CSymbolCircleGrid)
...
/////////////////////////////////////////////////////////////////////////////
// Standard CSymbolCircleGrid construction/destruction
CSymbolCircleGrid::CSymbolCircleGrid()
{
}
...
void CSymbolCircleGrid::OnSetup()
{
    const int rows = 0;
    const int cols = 6;
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnSheetSetup(int sheetNumber)
{
...
int CSymbolCircleGrid::OnCanMove(int oldcol, long oldrow, int newcol, long newrow)
{
...
int CSymbolCircleGrid::OnCanViewMove(int oldcol, long oldrow, int newcol, long newrow)
{
    UNREFERENCED_PARAMETER(oldcol);
    UNREFERENCED_PARAMETER(oldrow);
    UNREFERENCED_PARAMETER(newcol);
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnHitBottom(long numrows, long rowspast, long rowsfound)
{
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnHitTop(long numrows, long rowspast)
{
    UNREFERENCED_PARAMETER(numrows);
    UNREFERENCED_PARAMETER(rowspast);
}
...
int CSymbolCircleGrid::OnCanSizeCol(int col)
{
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnColSizing(int col, int *width)
{
    UNREFERENCED_PARAMETER(col);
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnColSized(int col, int *width)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(*width);
}
...
//      TRUE - to allow sizing
//      FALSE - to prevent sizing
int CSymbolCircleGrid::OnCanSizeRow(long row)
{
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnRowSizing(long row, int *height)
{
    UNREFERENCED_PARAMETER(row);
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnRowSized(long row, int *height)
{
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(*height);
}
...
//      TRUE - to allow sizing
//      FALSE - to prevent sizing
int CSymbolCircleGrid::OnCanSizeSideHdg()
{
    return TRUE;
}
...
int CSymbolCircleGrid::OnSideHdgSizing(int *width)
{
    UNREFERENCED_PARAMETER(*width);
    return TRUE;
}
...
int CSymbolCircleGrid::OnSideHdgSized(int *width)
{
    UNREFERENCED_PARAMETER(*width);
    return TRUE;
}
...
//      TRUE - to allow sizing
//      FALSE - to prevent sizing
int CSymbolCircleGrid::OnCanSizeTopHdg()
{
    return TRUE;
}
...
//      TRUE - to accept current new size
//      FALSE - to stop sizing, the size is either too large or too small
int CSymbolCircleGrid::OnTopHdgSizing(int *height)
{
    UNREFERENCED_PARAMETER(*height);
    return TRUE;
}
...
//      TRUE - to accept new size
//      FALSE - to revert to old size
int CSymbolCircleGrid::OnTopHdgSized(int *height)
{
    UNREFERENCED_PARAMETER(*height);
    return TRUE;
}
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnColChange(int oldcol, int newcol)
{
    UNREFERENCED_PARAMETER(oldcol);
    UNREFERENCED_PARAMETER(newcol);
}
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnRowChange(long oldrow, long newrow)
{
    UNREFERENCED_PARAMETER(oldrow);
    UNREFERENCED_PARAMETER(newrow);
}
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnCellChange(int oldcol, int newcol, long oldrow, long newrow)
{
    UNREFERENCED_PARAMETER(oldcol);
    UNREFERENCED_PARAMETER(newcol);
    UNREFERENCED_PARAMETER(oldrow);
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnLeftColChange(int oldcol, int newcol)
{
    UNREFERENCED_PARAMETER(oldcol);
    UNREFERENCED_PARAMETER(newcol);
}
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnTopRowChange(long oldrow, long newrow)
{
    UNREFERENCED_PARAMETER(oldrow);
    UNREFERENCED_PARAMETER(newrow);
}
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnViewMoved(int nScrolDir, long oldPos, long newPos)
{
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnSelectionChanged(int startCol, long startRow, int endCol, long endRow, int blockNum)
{
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnLClicked(int col, long row, int updn, RECT *rect, POINT *point, int processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnRClicked(int col, long row, int updn, RECT *rect, POINT *point, int processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(updn);
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnDClicked(int col, long row, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(*rect);
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnMouseMove(int col, long row, POINT *point, UINT nFlags, BOOL processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(*point);
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnTH_LClicked(int col, long row, int updn, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(updn);
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnTH_RClicked(int col, long row, int updn, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(updn);
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnTH_DClicked(int col, long row, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(*rect);
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnSH_LClicked(int col, long row, int updn, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(updn);
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnSH_RClicked(int col, long row, int updn, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(updn);
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnSH_DClicked(int col, long row, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(*rect);
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnCB_LClicked(int updn, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(updn);
    UNREFERENCED_PARAMETER(*rect);
    UNREFERENCED_PARAMETER(*point);
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnCB_RClicked(int updn, RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(updn);
    UNREFERENCED_PARAMETER(*rect);
    UNREFERENCED_PARAMETER(*point);
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnCB_DClicked(RECT *rect, POINT *point, BOOL processed)
{
    UNREFERENCED_PARAMETER(*rect);
    UNREFERENCED_PARAMETER(*point);
    UNREFERENCED_PARAMETER(processed);
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnKeyDown(UINT *vcKey, BOOL processed)
{
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnKeyUp(UINT *vcKey, BOOL processed)
{
    UNREFERENCED_PARAMETER(*vcKey);
    UNREFERENCED_PARAMETER(processed);
    //  GetScrollBarCtrl(SB_HORZ)->EnableScrollBar(ESB_DISABLE_BOTH);
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnCharDown(UINT *vcKey, BOOL processed)
{
    StartEdit(*vcKey);
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnGetCell(int col, long row, CUGCell *cell)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnSetCell(int col, long row, CUGCell *cell)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(*cell);
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnDataSourceNotify(int ID, long msg, long param)
{
...
int CSymbolCircleGrid::OnCellTypeNotify(long ID, int col, long row, long msg, long param)
{
    UNREFERENCED_PARAMETER(ID);
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
...
int CSymbolCircleGrid::OnEditStart(int col, long row, CWnd **edit)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
...
int CSymbolCircleGrid::OnEditVerify(int col, long row, CWnd *edit, UINT *vcKey)
{
...
int CSymbolCircleGrid::OnEditFinish(int col, long row, CWnd *edit, LPCTSTR string, BOOL cancelFlag)
{
    if (string == "")
...
int CSymbolCircleGrid::OnEditContinue(int oldcol, long oldrow, int *newcol, long *newrow)
{
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnMenuCommand(int col, long row, int section, int item)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
...
int CSymbolCircleGrid::OnMenuStart(int col, long row, int section)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(section);
...
DWORD CSymbolCircleGrid::OnGetContextHelpID(int col, long row, int section)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
    UNREFERENCED_PARAMETER(section);
...
int CSymbolCircleGrid::OnHint(int col, long row, int section, CString *string)
{
    UNREFERENCED_PARAMETER(section);
...
//      TRUE - to show the hint
//      FALSE - to prevent the hint from showing
int CSymbolCircleGrid::OnVScrollHint(long row, CString *string)
{
    UNREFERENCED_PARAMETER(row);
...
//      TRUE - to show the hint
//      FALSE - to prevent the hint from showing
int CSymbolCircleGrid::OnHScrollHint(int col, CString *string)
{
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(*string);
    return TRUE;
...
DROPEFFECT CSymbolCircleGrid::OnDragEnter(COleDataObject *pDataObject)
{
...
//      DROPEFFECT_NONE - no drag and drop
//      DROPEFFECT_COPY - allow drag and drop for copying
DROPEFFECT CSymbolCircleGrid::OnDragOver(COleDataObject *pDataObject, int col, long row)
{
    UNREFERENCED_PARAMETER(*pDataObject);
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
...
//      DROPEFFECT_NONE - no drag and drop
//      DROPEFFECT_COPY - allow drag and drop for copying
DROPEFFECT CSymbolCircleGrid::OnDragDrop(COleDataObject *pDataObject, int col, long row)
{
    UNREFERENCED_PARAMETER(*pDataObject);
    UNREFERENCED_PARAMETER(col);
    UNREFERENCED_PARAMETER(row);
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnScreenDCSetup(CDC *dc, int section)
{
...
int CSymbolCircleGrid::OnSortEvaluate(CUGCell *cell1, CUGCell *cell2, int flags)
{
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnTabSelected(int ID)
{
    UNREFERENCED_PARAMETER(ID);
}
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnAdjustComponentSizes(RECT *grid, RECT *topHdg, RECT *sideHdg,
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnDrawFocusRect(CDC *dc, RECT *rect)
{
...
COLORREF CSymbolCircleGrid::OnGetDefBackColor(int section)
{
    UNREFERENCED_PARAMETER(section);
...
//      <none>
//
void CSymbolCircleGrid::OnSetFocus(int section)
{
    UNREFERENCED_PARAMETER(section);
}
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnKillFocus(int section, CWnd *pNewWnd)
{
    UNREFERENCED_PARAMETER(section);
}
...
BOOL CSymbolCircleGrid::OnColSwapStart(int col)
{
    UNREFERENCED_PARAMETER(col);
    return TRUE;
}
...
//      TRUE - to allow for the swap to take place
//      FALSE - to disallow the swap
BOOL CSymbolCircleGrid::OnCanColSwap(int fromCol, int toCol)
{
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnColSwapped(int fromCol, int toCol)
{
    UNREFERENCED_PARAMETER(fromCol);
    UNREFERENCED_PARAMETER(toCol);
}
...
//  Return:
//      <none>
void CSymbolCircleGrid::OnTrackingWindowMoved(RECT *origRect, RECT *newRect)
{
    UNREFERENCED_PARAMETER(*origRect);
    UNREFERENCED_PARAMETER(*newRect);
}

int CSymbolCircleGrid::AddNewRow(void)
{
...
int CSymbolCircleGrid::DeleteSelectedRow(void)
{
...
bool CSymbolCircleGrid::RowHasBeenEdited(int row)
{
...
void CSymbolCircleGrid::InitializeRow(int row)
{
    int numCols = GetNumberCols();
...
void CSymbolCircleGrid::RenumberRows(void)
{
    int numRows = GetNumberRows();
